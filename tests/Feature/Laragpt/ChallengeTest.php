...
class ChallengeTest extends TestCase
{
    ...
    */
     ...
     */
     ...
     /**
     * test Exception when challenge send page with value Zero .
     ...
     */
     ...
     /**
     * test Exception when challenge send page with not integer value.
     ...
     */
     ...
     /**
     * test when challenge send page with value greater than the pages exist according registries of database.
     ...
     */
     ...
     /**
     * test when challenge send page with value greater than the first page according registries of database.
   ...
   /**
     * test when specific challenge not exists in databse
     * you can call only This test of this way php artisan test --filter testChallengeGetByIdNotFound
     * @return  void
     */
    public function testChallengeGetByIdNotFound()
    {
        $id = 3;
        $response = $this->get('/api/challenges/'.$id);

        $response->assertStatus(404)
            ->assertJson([
                'message' => 'No exists challenge with id : '.$id
            ]);
    }
